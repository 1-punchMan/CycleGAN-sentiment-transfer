    ...
    def step(generator_X2Y, generator_Y2X, X, Y, discriminator_X, discriminator_Y, params):  
        ...
        try:
            ...
            with tf.GradientTape(persistent=True) as tape:
                ...
                reconstruction_loss = (loss_XYX + loss_YXY) * 2
                loss_X2Y = reconstruction_loss - false_Y_sample_score
                loss_Y2X = reconstruction_loss - false_X_sample_score
                # loss_X2Y = loss_XYX - false_Y_sample_score*0.1
                # loss_Y2X = loss_YXY - false_X_sample_score*0.1

            if generator_X2Y.optimizer.iterations == generator_Y2X.optimizer.iterations:    # For situations that OOM happens and we run a new step.
            ...
            loss_X2Y = loss_XYX = loss_Y2X = loss_YXY = None
